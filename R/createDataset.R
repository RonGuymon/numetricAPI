#' @title Create a new dataset (V2)
#' @description Create a new dataset in a Numetric Org.
#'
...
#' @return Returns the dataset id as a string.
#' @export
createDataset <- function(apiKey, numetricName, dataframeName, category = "New Data", primaryKey, autocompletes = "", geoshapes = "", geopoints = "", boolean = "", everyone = "false"){
  ...
  metadata <- paste('{"name": "', numetricName,
                    ...
                    '}',
                    sep = "")
  r <- POST("https://api.numetric.com/v2/dataset",
